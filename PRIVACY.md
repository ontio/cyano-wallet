...
<ul>
    ...
    <li>
        ...
        <p>Debug Data is data collected automatically in case of a fault in the Service (last clicked Button in service before the fault). The Debug Data are anonymous and does not contain identification informations</p>
    </li>
    <li>
...
<ul>
<li>Email</li><li>Cookies and Usage Data</li>
</ul>
...
<h4>Debug Data</h4>
<p>While using our Service, a software error in the Service may occur. In this case a debug report is created and send to an automatic monitoring system for later problem analysis.</p>
...
<p>As an European citizen, under GDPR, you have certain individual rights. You can learn more about these rights in the <a href="https://termsfeed.com/blog/gdpr/#Individual_Rights_Under_the_GDPR">GDPR Rights</a>.</p>
