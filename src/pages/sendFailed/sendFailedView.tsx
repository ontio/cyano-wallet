  ...
  <View orientation="column" fluid={true}>
    <View orientation="column" className="part gradient">
      ...
      <View content={true} className="spread-around">
        <View>The transaction timeout.</View>
      </View>
    </View>
    <View orientation="column" fluid={true} content={true} className="spread-around">
      <Message>Your transaction of {props.amount} {props.asset} to {props.recipient} has not completed in time. This does not mean it necessarily failed. Check your balances.</Message>
      <Filler />
